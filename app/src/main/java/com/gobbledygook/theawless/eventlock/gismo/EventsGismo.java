...
public class EventsGismo {
    ...
    public void scrollToEvent() {
        if (recyclerView.getAdapter() != null && 0 <= eventsAdapter.scrollEventIndex && eventsAdapter.scrollEventIndex < eventsAdapter.events.get(Enums.EventInfo.Title.ordinal()).size()) {
